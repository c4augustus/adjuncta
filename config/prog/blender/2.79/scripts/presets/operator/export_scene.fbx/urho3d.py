...
op.filepath = '/Users/admin/w/withme/repo/FaceTwoAndroid/content/fbx/head0001-blend-export.fbx'
op.axis_forward = 'Z'
op.axis_up = 'Y'
op.version = 'BIN7400'
op.ui_tab = 'MAIN'
op.use_selection = False
op.global_scale = 0.009999999776482582
op.apply_unit_scale = True
op.apply_scale_options = 'FBX_SCALE_NONE'
op.bake_space_transform = False
op.object_types = {'LAMP', 'ARMATURE', 'CAMERA', 'OTHER', 'MESH', 'EMPTY'}
